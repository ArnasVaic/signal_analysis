...
@heart_sound_sig matome pavyzdinį sveiko vyro dešiniosios viršutinės krūtinkaulio kraštinės (širdies) garso įrašą paimtą iš širdies ir plaučių duomenų rinkinio įrašyto su klinikiniu manekenu naudojant skaitmeninį stetoskopą @hls-cmds. Garso įrašo diskretizavimo dažnis (_angl. sampling rate_) yra $4000$Hz. Prieš rekurentinių diagramų generavimą duomenys buvo praretinti 100 kartų. Rezultate diagramos buvo generuojamos iš signalo, kurio imčių skaičius yra $N=599$.
...
@heart_sound_rd matome, kad širdies garso signalas pasižymi beveik homogenišku juodų taškų išsidėstymu, kas žymi signalo stacionarumą. Išsidėstymas turi nežymią tvarką, kuri nyksta didinant parametrą $d$ ir kartu su homogenišku juodų taškų pasiskirstymu žymi vyraujantį atsitiktinį triukšmą.