...
#figure(
  ...
  caption: [Jungtinė rekurentinė diagrama gauta naudojant anksčiau apibūdintą techniką. 2025m. duomenys buvo sukarpyti į dvylika dalių (po diagramą kiekvienam iš mėnesių, tačiau norint užtikrinti tokį patį diagramų dydi buvo paimtos tik pirmos 28 kiekvieno mėnesio dienos). Kiekvienai signalo atkarpai buvo sudaryta rekurentinė diagrama su parametrais $D=2, p=0.3, d=1$. Bendras rezultatas matomas kairėje, tačiau dėl didelės diagramos raiškos įdėtos individualių dienų iškarpos. Centre matome 8 mėnesio dienos iškarpą esančia ant pagrindinės diagonalės, o dešinėje iškarpą ne ant pagrindinės diagonalės -- 8 d., 15 d. Visoms diagramoms naudojama "Viridis" spalvų paletė.]
) <energy_img>
