...
@lung_sound_sig[Pav.] matome pavyzdinį sveikos moters dešiniojo viršutinio priekinio plaučio garso įrašą paimtą iš širdies ir plaučių duomenų rinkinio įrašyto su klinikiniu manekenu naudojant skaitmeninį stetoskopą @hls-cmds. Garso įrašo diskretizavimo dažnis (_angl. sampling rate_) yra $4000$Hz. Prieš rekurentinių diagramų generavimą duomenys buvo praretinti 100 kartų. Rezultate diagramos buvo generuojamos iš signalo, kurio imčių skaičius yra $N=599$.
